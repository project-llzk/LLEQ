# Based on the LLZK flake
{
  inputs = {
    ...
    llzk = {
      url = "github:project-llzk/llzk-lib?rev=b2332233f336c56b6b3661719d980db4f6694214";
  ...
  outputs = { self, nixpkgs, flake-utils, llzk-pkgs, release-helpers, llzk }:
    {
      ...
      overlays.default = final: prev: {
        ...
        lleqGCC = (final.lleq.override { stdenv = final.gccStdenv; llzk = final.llzk; mlir = final.mlir; }).overrideAttrs(attrs: {
          cmakeBuildType = "RelWithDebInfo";
        });
      };
    } //
